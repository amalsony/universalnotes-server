...
Include a gender in the output as shown in the example based on the predicted gender of the user but you can also infer based on the input garment to make a better guess as the predicted gender may be wrong.
